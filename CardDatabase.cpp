...
CardDatabase::CardDatabase() {
	...
	cards[3] = new Card("Suit Up", "Raises defense by 3 + half your defense, and heal 5 hp.", Card::cardtype::defense, item::combattype::flexible, Card::effecttype::increase_defense, Card::effecttype::heal_hp, Card::effecttype::none, 3, 1.0f, 0, 0);
	...
	cards[5] = new Card("Be Alert!", "Become alert; If enemy uses at least 2 attack cards next turn, negate one of the cards' effects.", Card::cardtype::trap, item::combattype::none, Card::effecttype::negate_attack_card, Card::effecttype::none, Card::effecttype::none, 1, 1.0f, 0, 1);
	...
	cards[13] = new Card("Charge!!!", "Charges straight to the enemy like a bull for one turn, reducing both your defenses by 5, then dealing massive damage the next.", Card::cardtype::attack, item::combattype::projectile, Card::effecttype::deal_damage, Card::effecttype::lower_own_defense, Card::effecttype::prepare_upclose, 5, 2.0f, 1, 1);
	...
	cards[18] = new Card("Suit Up", "Increases your defense by", Card::cardtype::defense, item::combattype::flexible, Card::effecttype::increase_defense, Card::effecttype::none, Card::effecttype::none, 0, 1.0f, 0, 0);
	//advanced mdef
	cards[19] = new Card("Phalanxing", "Phalanxing solo might not be the best move... Increases melee defense and attack. Increases even more if enemy deals 10 damage to you in the next turn", Card::cardtype::hybrid, item::combattype::melee, Card::effecttype::phalanxing, Card::effecttype::none, Card::effecttype::none, 0, 1.0f, 0, 1);
	cards[20] = new Card("From The Trenches", "Being weaker makes you stronger. Or something like that.", Card::cardtype::defense, item::combattype::flexible, Card::effecttype::defense_from_hp_lost, Card::effecttype::none, Card::effecttype::none, 0, 0.5f, 0, 0);
	...
	//advanced pdef
	cards[22] = new Card("Unstoppable", "Can't stop the A-train. Become unstoppable to any obstacles(skips)! (except maybe a banana peel)", Card::cardtype::hybrid, item::combattype::none, Card::effecttype::skip_immunity, Card::effecttype::none, Card::effecttype::none, 0, 1.0f, 0, 1);
	cards[23] = new Card("Mats", "Like the thing from fortnite. Increase projectile defense by 10, and	regain 10 hp, but be unable to attack for the next.", Card::cardtype::hybrid, item::combattype::projectile, Card::effecttype::increase_defense, Card::effecttype::cannot_attack, Card::effecttype::heal_hp, 10, 1.0f, 0, 1);
	...
	cards[26] = new Card("Donation", "If you get any stat buffs in the next turn, it will go to them.", Card::cardtype::trap, item::combattype::none, Card::effecttype::donation, Card::effecttype::none, Card::effecttype::none, 0, 1.0f, 0, 1);
	...
	cards[29] = new Card("Bullseye", "They fire a bullet that penetrates your defense.", Card::cardtype::attack, item::combattype::projectile, Card::effecttype::deal_damage, Card::effecttype::ignore_defense, Card::effecttype::none, 0, 1.0f, 1, 0);
	...
	//grim
	cards[31] = new Card("Radial Slash", "They slash at you twice, reducing your melee defense by 3 with each hit.", Card::cardtype::attack, item::combattype::melee, Card::effecttype::deal_damage, Card::effecttype::lower_defense, Card::effecttype::none, 3, 1.0f, 2, 0);
	...
	cards[33] = new Card("Grievance", "They grieve (maybe for your loss), for a turn, unable to attack. They then raise their melee attack and defense by 2.", Card::cardtype::hybrid, item::combattype::melee, Card::effecttype::increase_defense, Card::effecttype::increase_attack, Card::effecttype::cannot_attack, 2, 1.0f, 0, 1);
	//trickster
	...
	cards[35] = new Card("Burvju Gredzens", "They summon a magic ring, giving them a temporary projectile defense boost, and a 25% chance to reflect projectiles.", Card::cardtype::hybrid, item::combattype::flexible, Card::effecttype::increase_defense, Card::effecttype::chance_reflect_projectile, Card::effecttype::none, 5, 1.0f, 0, 2);
	cards[36] = new Card("Ilūzija", "You're under an illusion. Is anything real? Is this card real?", Card::cardtype::hybrid, item::combattype::none, Card::effecttype::illusioned, Card::effecttype::none, Card::effecttype::none, 0, 1.0f, 1, 1); //gives player the illusioned state (trickster -5 both defense) can be cancelled if player deals at least 10 damage
	cards[37] = new Card("Ilūzija", "You're under an illusion. Is anything real? Is this card real?", Card::cardtype::trap, item::combattype::none, Card::effecttype::reflect_damage, Card::effecttype::none, Card::effecttype::none, 0, 1.0f, 0, 1); //reflects all damage next turn
	...
	//survivor phase 1
	cards[39] = new Card("Kinetic Strike", "They strike you, dealing damage and taunting you.", Card::cardtype::attack, item::combattype::melee, Card::effecttype::deal_damage, Card::effecttype::taunted, Card::effecttype::none, 0, 1.0f, 1, 0);
	...
	//01
	cards[48] = new Card("Fuerza", "Power. Isn't this what you wanted? He deals massive damage, ignoring any shields.", Card::cardtype::attack, item::combattype::melee, Card::effecttype::deal_damage, Card::effecttype::ignore_shield, Card::effecttype::none, 0, 1.5f, 1, 0);
	...
	cards[50] = new Card("Retribution", "He will make you pay for your sins. Reflects 25% damage for the next 3 turns.", Card::cardtype::hybrid, item::combattype::melee, Card::effecttype::reflect_damage, Card::effecttype::none, Card::effecttype::none, 0, 0.25f, 0, 3);
	cards[51] = new Card("Feral Fury", "This is what you made. Are you happy? He deals damage based on your current health.", Card::cardtype::attack, item::combattype::melee, Card::effecttype::hp_scaled_damage, Card::effecttype::none, Card::effecttype::none, 0, 1.0f, 0, 1); //at 100 health, 2x damage. At 50, 1x, At 25, 0.5x
	//tutorial purposes
	...
	cards[53] = new Card("Rest", "They increase defense and heal hp.", Card::cardtype::defense, item::combattype::flexible, Card::effecttype::increase_defense, Card::effecttype::heal_hp, Card::effecttype::none, 0, 1.0f, 1, 0);
}
