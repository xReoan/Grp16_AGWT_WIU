...
CardDatabase::CardDatabase() {
	...
	cards[6] = new Card("Watch!", "Watch their every move...; If enemy uses at least 2 defense cards next turn, negate one of the cards' effects.", Card::cardtype::trap, item::combattype::none, Card::effecttype::negate_defense_card, Card::effecttype::none, Card::effecttype::none, 1, 1.0f, 0, 1);
	...
	cards[18] = new Card("Armor Polish", "Increases your defense by", Card::cardtype::defense, item::combattype::flexible, Card::effecttype::increase_defense, Card::effecttype::none, Card::effecttype::none, 0, 1.0f, 0, 0);
	...
	cards[20] = new Card("From The Trenches", "Being weaker makes you stronger. Or something like that. Raise defense", Card::cardtype::defense, item::combattype::flexible, Card::effecttype::defense_from_hp_lost, Card::effecttype::none, Card::effecttype::none, 0, 0.5f, 0, 2);
	...
	//advanced pdef
	cards[22] = new Card("Unstoppable", "Reesist melee attacks.for the next turn", Card::cardtype::hybrid, item::combattype::none, Card::effecttype::half_damage_next_turn, Card::effecttype::none, Card::effecttype::none, 0, 0.5f, 0, 1);
	...
	//grim
	cards[31] = new Card("Radial Slash", "They slash at you twice, reducing your melee defense by 3 with each hit.", Card::cardtype::attack, item::combattype::melee, Card::effecttype::deal_damage, Card::effecttype::lower_defense, Card::effecttype::poison_tip, 3, 1.0f, 2, 2);
	...
	//01
	cards[48] = new Card("Fuerza", "Power. Isn't this what you wanted? He deals massive damage, ignoring any shields.", Card::cardtype::attack, item::combattype::melee, Card::effecttype::ignore_shield, Card::effecttype::deal_damage, Card::effecttype::poison_tip, 0, 1.5f, 1, 2);
	...
	cards[53] = new Card("Rest", "They increase defense and heal hp.", Card::cardtype::defense, item::combattype::flexible, Card::effecttype::increase_defense, Card::effecttype::heal_hp, Card::effecttype::none, 5, 1.0f, 1, 0);
}
