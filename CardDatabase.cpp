...
CardDatabase::CardDatabase() {
	...
	cards[3] = new Card("Suit Up", "Raises defense by 3 + half your defense.", Card::cardtype::defense, item::combattype::flexible, Card::effecttype::increase_defense, Card::effecttype::none, Card::effecttype::none, 3, 1.0f, 0, 0);
	...
	cards[22] = new Card("Mats", "Like the thing from fortnite. Increase projectile defense by 10, and	regain 10 hp, but be unable to attack for the next.", Card::cardtype::hybrid, item::combattype::projectile, Card::effecttype::increase_defense, Card::effecttype::cannot_attack, Card::effecttype::none, 10, 1.0f, 0, 1);
	...
	//gunman
	cards[26] = new Card("Death Blossom", "They deal damage, and lower your projectile defense by 2.", Card::cardtype::attack, item::combattype::projectile, Card::effecttype::deal_damage, Card::effecttype::lower_defense, Card::effecttype::none, 2, 0.5f, 1, 0);
	...
	//grim
	cards[29] = new Card("Radial Slash", "They slash at you twice, reducing your melee defense by 3 with each hit.", Card::cardtype::attack, item::combattype::melee, Card::effecttype::deal_damage, Card::effecttype::lower_defense, Card::effecttype::none, 3, 1.0f, 2, 0);
	...
	cards[31] = new Card("Grievance", "They grieve (maybe for your loss), for a turn, unable to attack. They then raise their melee attack and defense by 2.", Card::cardtype::hybrid, item::combattype::melee, Card::effecttype::increase_defense, Card::effecttype::increase_attack, Card::effecttype::cannot_attack, 2, 1.0f, 0, 1);
	//trickster
	...
	cards[33] = new Card("Burvju Gredzens", "They summon a magic ring, giving them a temporary projectile defense boost, and a 25% chance to reflect projectiles.", Card::cardtype::hybrid, item::combattype::flexible, Card::effecttype::increase_defense, Card::effecttype::chance_reflect_projectile, Card::effecttype::none, 5, 1.0f, 0, 2);
	...
	cards[38] = new Card("Horixon Valor", "They are fueled by this duel. +3 both defenses.", Card::cardtype::defense, item::combattype::flexible, Card::effecttype::increase_defense, Card::effecttype::none, Card::effecttype::none, 3, 1.0f, 0, 0);
	cards[39] = new Card("Tharos", "Increases melee attack by 7 for one turn.", Card::cardtype::hybrid, item::combattype::melee, Card::effecttype::increase_attack, Card::effecttype::none, Card::effecttype::none, 7, 1.0f, 0, 1);
	...
	cards[42] = new Card("Bliss, On The Horizon's Edge", "They are at peace. +5 melee defense, +20 shield.", Card::cardtype::defense, item::combattype::melee, Card::effecttype::increase_defense, Card::effecttype::shield, Card::effecttype::none, 5, 1.0f, 0, 0);
	cards[43] = new Card("Tharos: Reprise", "Increases melee attack by 10 for one turn.", Card::cardtype::hybrid, item::combattype::melee, Card::effecttype::increase_attack, Card::effecttype::none, Card::effecttype::none, 10, 1.0f, 0, 1);
	...
	cards[45] = new Card("Final Test", "You're about to leave. Aren't you happy?", Card::cardtype::hybrid, item::combattype::none, Card::effecttype::finaltest_damage, Card::effecttype::none, Card::effecttype::none, 0, 1.0f, 1, 0); //under 5 hp, leave player at 1hp, and drop defense to -100
	//01
