...
itemDatabase::itemDatabase() {
	...
	items[6] = new item("Cardboard Box", "makes you feel homeless. or like a hermit crab", item::itemtype::armor, item::equipment::basic, item::combattype::none, 0, 4, 0, 0, 5);
	items[7] = new item("Lab Coat", "wearing this makes you feel slightly smarter. only slightly.", item::itemtype::armor, item::equipment::basic, item::combattype::none, 0, 6, 0, 0, 8);
	items[8] = new item("oooh Shiny Armor", "so shiny you could die", item::itemtype::armor, item::equipment::advanced, item::combattype::melee, 0, 12, 0, 0, 15);
	items[9] = new item("Leftover Jelly", "leftover jelly left since 1945. goes well with milk.", item::itemtype::armor, item::equipment::advanced, item::combattype::projectile, 0, 10, 0, 0, 15);
