...
itemDatabase::itemDatabase() {
	...
	items[10] = new item("Cake...?", "a sus piece of cake. surprisingly fresh...?", item::itemtype::consumable, item::combattype::none, 0, 0, 7, 0, 7);
	items[11] = new item("Needle", "looks like its been used, do you have anything else? please say yes, dont use this.", item::itemtype::consumable, item::combattype::none, 0, 0, 10, 0, 5);
	items[12] = new item("Bandage", "random bandage. there doesn't seem to be a medkit, however...", item::itemtype::consumable, item::combattype::none, 0, 0, 2, 5, 5);
	items[13] = new item("Instant Ramen", "quick and easy meal. cleanses your bowels too, contrary to popular belief.", item::itemtype::consumable, item::combattype::none, 0, 0, 10, 0, 10);
	items[14] = new item("Cheese", "takes the form of your favourite cheese. yum!", item::itemtype::consumable, item::combattype::none, 0, 0, 20, 0, 15);
}
